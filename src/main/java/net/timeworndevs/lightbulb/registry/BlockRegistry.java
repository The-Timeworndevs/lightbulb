...
public class BlockRegistry {
    ...
    public static final ButtonBlock WHITE_GLOWBUTTON = new ButtonBlock(AbstractBlock.Settings.create().mapColor(MapColor.WHITE).hardness(0.3f).luminance((state) -> {return 15;}).sounds(BlockSoundGroup.GLASS).noCollision(), BlockSetType.STONE, 20, false);
    public static final ButtonBlock LIGHT_GRAY_GLOWBUTTON = new ButtonBlock(AbstractBlock.Settings.create().mapColor(MapColor.LIGHT_GRAY).hardness(0.3f).luminance((state) -> {return 15;}).sounds(BlockSoundGroup.GLASS).noCollision(), BlockSetType.STONE, 20, false);
    public static final ButtonBlock GRAY_GLOWBUTTON = new ButtonBlock(AbstractBlock.Settings.create().mapColor(MapColor.GRAY).hardness(0.3f).luminance((state) -> {return 15;}).sounds(BlockSoundGroup.GLASS).noCollision(), BlockSetType.STONE, 20, false);
    public static final ButtonBlock BLACK_GLOWBUTTON = new ButtonBlock(AbstractBlock.Settings.create().mapColor(MapColor.BLACK).hardness(0.3f).luminance((state) -> {return 15;}).sounds(BlockSoundGroup.GLASS).noCollision(), BlockSetType.STONE, 20, false);
    public static final ButtonBlock BROWN_GLOWBUTTON = new ButtonBlock(AbstractBlock.Settings.create().mapColor(MapColor.BROWN).hardness(0.3f).luminance((state) -> {return 15;}).sounds(BlockSoundGroup.GLASS).noCollision(), BlockSetType.STONE, 20, false);
    public static final ButtonBlock RED_GLOWBUTTON = new ButtonBlock(AbstractBlock.Settings.create().mapColor(MapColor.RED).hardness(0.3f).luminance((state) -> {return 15;}).sounds(BlockSoundGroup.GLASS).noCollision(), BlockSetType.STONE, 20, false);
    public static final ButtonBlock ORANGE_GLOWBUTTON = new ButtonBlock(AbstractBlock.Settings.create().mapColor(MapColor.ORANGE).hardness(0.3f).luminance((state) -> {return 15;}).sounds(BlockSoundGroup.GLASS).noCollision(), BlockSetType.STONE, 20, false);
    public static final ButtonBlock YELLOW_GLOWBUTTON = new ButtonBlock(AbstractBlock.Settings.create().mapColor(MapColor.YELLOW).hardness(0.3f).luminance((state) -> {return 15;}).sounds(BlockSoundGroup.GLASS).noCollision(), BlockSetType.STONE, 20, false);
    public static final ButtonBlock LIME_GLOWBUTTON = new ButtonBlock(AbstractBlock.Settings.create().mapColor(MapColor.LIME).hardness(0.3f).luminance((state) -> {return 15;}).sounds(BlockSoundGroup.GLASS).noCollision(), BlockSetType.STONE, 20, false);
    public static final ButtonBlock GREEN_GLOWBUTTON = new ButtonBlock(AbstractBlock.Settings.create().mapColor(MapColor.GREEN).hardness(0.3f).luminance((state) -> {return 15;}).sounds(BlockSoundGroup.GLASS).noCollision(), BlockSetType.STONE, 20, false);
    public static final ButtonBlock CYAN_GLOWBUTTON = new ButtonBlock(AbstractBlock.Settings.create().mapColor(MapColor.CYAN).hardness(0.3f).luminance((state) -> {return 15;}).sounds(BlockSoundGroup.GLASS).noCollision(), BlockSetType.STONE, 20, false);
    public static final ButtonBlock LIGHT_BLUE_GLOWBUTTON = new ButtonBlock(AbstractBlock.Settings.create().mapColor(MapColor.LIGHT_BLUE).hardness(0.3f).luminance((state) -> {return 15;}).sounds(BlockSoundGroup.GLASS).noCollision(), BlockSetType.STONE, 20, false);
    public static final ButtonBlock BLUE_GLOWBUTTON = new ButtonBlock(AbstractBlock.Settings.create().mapColor(MapColor.BLUE).hardness(0.3f).luminance((state) -> {return 15;}).sounds(BlockSoundGroup.GLASS).noCollision(), BlockSetType.STONE, 20, false);
    public static final ButtonBlock PURPLE_GLOWBUTTON = new ButtonBlock(AbstractBlock.Settings.create().mapColor(MapColor.PURPLE).hardness(0.3f).luminance((state) -> {return 15;}).sounds(BlockSoundGroup.GLASS).noCollision(), BlockSetType.STONE, 20, false);
    public static final ButtonBlock MAGENTA_GLOWBUTTON = new ButtonBlock(AbstractBlock.Settings.create().mapColor(MapColor.MAGENTA).hardness(0.3f).luminance((state) -> {return 15;}).sounds(BlockSoundGroup.GLASS).noCollision(), BlockSetType.STONE, 20, false);
    public static final ButtonBlock PINK_GLOWBUTTON = new ButtonBlock(AbstractBlock.Settings.create().mapColor(MapColor.PINK).hardness(0.3f).luminance((state) -> {return 15;}).sounds(BlockSoundGroup.GLASS).noCollision(), BlockSetType.STONE, 20, false);
